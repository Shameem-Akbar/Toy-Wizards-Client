...
const NavigationBar = () => {
    ...
    return (
        <div className='px-2 md:px-12 py-2'>
            <div className="navbar bg-transparent py-0 pl-0 lg:px-8 md:py-5 border border-gray-600 shadow-md shadow-slate-600">
                <div className="navbar-start">
                    <div className="dropdown">
                        <label tabIndex={0} className="btn btn-ghost lg:hidden">
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 6h16M4 12h8m-8 6h16" /></svg>
                        </label>
                        <ul tabIndex={0} className="menu menu-compact dropdown-content mt-3 shadow bg-[#0B1320] rounded w-52">
                ...
                <div className="navbar-end">
                    {
                        user ?
                            <div className="flex gap-1">
                                ...
                                <button onClick={handleLogOut} className="btn btn-primary btn-sm mt-2 md:mt-0 md:btn-md text-white">Log Out</button>
                            </div> :
