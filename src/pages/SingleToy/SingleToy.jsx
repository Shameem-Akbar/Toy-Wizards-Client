    ...
    return (
        <div className='px-2 lg:px-20 py-2 md:py-5'>
            <div className='my-3' style={{ overflowX: 'hidden' }}>
                <Marquee direction="left" pauseOnHover={true} gradient={true} gradientColor={[255, 255, 255]}>
                    <h1 style={{
                        color: '#eb212e',
                        fontSize: '32px',
                        fontWeight: 'bold',
            ...
            <div className='grid grid-cols-5 gap-2 mt-6'>
                ...
                <div>
                    <h2 className='font-bold text-center text-2xl bg-red-600 text-white rounded py-2 shadow-xl'>YOU MAY ALSO LIKE</h2>
